...
export default function AboutHero() {
    return (
        <section aria-label="About Us Hero" className="relative w-full overflow-hidden bg-slate-950 min-h-[240px] sm:min-h-[280px] lg:min-h-[310px] flex items-center py-8 sm:py-10">

...
export default function CareerHero() {
    return (
        <section aria-label="Careers Hero Banner" className="relative w-full overflow-hidden bg-slate-950 min-h-[240px] sm:min-h-[280px] lg:min-h-[310px] flex items-center py-8 sm:py-10">
            {/* Background Image with Natural Proportional Framing */}
            <Image
                src="/career/carrerbanner.png"
                alt="Aurevia Healthcare careers banner"
                fill
                priority
                unoptimized={true}

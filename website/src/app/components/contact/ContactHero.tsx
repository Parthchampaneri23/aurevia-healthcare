...
export default function ContactHero() {
    return (
        <section aria-label="Contact Us Hero Banner" className="relative w-full overflow-hidden bg-slate-950 min-h-[240px] sm:min-h-[280px] lg:min-h-[310px] flex items-center py-8 sm:py-10">
            {/* Background Image with Natural Proportional Framing */}
            <Image
                src="/contact/contacthero.png"
                alt="Aurevia Healthcare contact banner"
                fill
                priority
                unoptimized={true}
